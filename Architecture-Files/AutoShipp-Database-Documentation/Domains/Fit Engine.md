...
## 2. Why does it exist?
While the `public` schema tracks *what* a product is (Commerce), the `fit` schema calculates *how* it fits a specific person. It decouples complex AI/ML data from standard transactional commerce data.

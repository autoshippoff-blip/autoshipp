...
- **`identity_user_roles`**: Assigns a role to a user _within the context of a specific account_.
...
- Assigning a role to a user _without_ specifying the `account_id`. Roles are almost always tenant-scoped, not global.

...
const BIG_NUMBERS = [
  {
    label: "RTOs Prevented",
    value: "284",
    sub: "vs 412 last month",
    icon: ShieldCheck,
    color: "emerald",
    trend: "-31%",
  },
            ...
            <div className="flex items-center justify-between mb-8">
              <div>
                ...
                <p className="text-xs text-slate-500">
                  Tracking every step from Shopify sync to successful delivery.
                </p>
              </div>
                ...
                <div key={step.label} className="group">
                  <div className="flex justify-between items-end mb-1 px-1">
                    ...
                    <span className="text-xs font-mono font-bold text-slate-300">
                      ...
                      <span className="text-slate-600 ml-1">({step.pct}%)</span>
                    </span>
                  </div>
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <p className="text-sm text-slate-400 leading-relaxed">
                Your RTO rate dropped from{" "}
                <strong className="text-emerald-300">29.4%</strong> to{" "}
                <strong className="text-emerald-300">20.3%</strong>. Automation
                successfully filtered{" "}
                <strong className="text-white">128 fake orders</strong> this
                month that would have otherwise cost ₹64,000 in logistics.
              </p>
            ...
            <div className="bg-white/[0.02] border border-white/10 rounded-3xl p-6">
              ...
              <p className="text-[10px] text-slate-500 mt-3 italic">
                &quot;Customers are most responsive between 11 AM - 1 PM.&quot;
              </p>
            </div>
          </div>
        </div>
    ...
    >
      <div className="flex justify-between items-start mb-4">
        ...
        <div className="flex flex-col items-end">
          <span
            className={`text-[10px] font-black flex items-center gap-1 ${trend.includes("+") ? "text-emerald-400" : "text-slate-400"}`}
          >
            {trend}{" "}
            {trend.includes("+") && (
              <ArrowDownRight className="w-3 h-3 rotate-[270deg]" />
            )}
          </span>
        </div>
      </div>

  ...
  const fetchWalletData = async () => {
    try {
      ...
      const [balanceData, txData] = await Promise.all([
        ...
        walletApi.getMyTransactions(page, 20),
      ]);
      ...
      return (
        <div className="min-h-screen p-6 max-w-[1600px] mx-auto">
          <EmptyState
            ...
            description="Your organization does not have an active wallet. Please contact support."
          />
        </div>
      );
    }
        ...
        <div className="mt-8">
          ...
          {transactions.length === 0 ? (
            <EmptyState
              ...
              description="Your wallet history will appear here once you start processing transactions."
            />
          ) : (

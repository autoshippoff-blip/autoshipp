  ...
  <div className="relative w-full max-w-[320px] bg-card border border-border rounded-[2.5rem] shadow-2xl overflow-hidden aspect-[9/19] flex flex-col ring-8 ring-background">
    ...
    <div className="absolute top-1/4 -left-12 lg:-left-20 bg-card border border-border p-4 rounded-2xl shadow-xl flex items-center gap-4 animate-[bounce_4s_infinite]">
      ...
      <div className="flex flex-col pr-4">
        <span className="text-sm font-bold text-foreground">AI Resolution</span>
    ...
    <div className="absolute bottom-1/3 -right-8 lg:-right-12 bg-primary text-primary-foreground p-4 rounded-2xl shadow-xl flex flex-col gap-1 animate-[bounce_5s_infinite_reverse]">
      <span className="text-sm font-bold opacity-90">Wait Time</span>
      <span className="text-2xl font-black">0 Sec</span>
    </div>
  </div>
);
...
const EngageVisual = () => (
  <div className="relative w-full max-w-[320px] bg-card border border-border rounded-[2.5rem] shadow-2xl overflow-hidden aspect-[9/19] flex flex-col ring-8 ring-background">
    ...
    <div className="flex-1 p-5 flex flex-col gap-4 bg-[#EFEAE2]">
      <div className="self-center bg-black/10 px-3 py-1 rounded-lg text-[10px] text-black/60 mb-2">
        Today
      </div>
      <div className="self-start max-w-[90%] bg-white p-3 rounded-2xl rounded-tl-sm text-xs shadow-sm">
        ...
        Hey there! 👋 Your favorite sneakers are back in stock. Tap below to
        claim your exclusive 50% discount.
        <div className="mt-3 w-full py-2 bg-[#25D366]/10 text-[#075E54] font-bold text-center rounded-lg border border-[#25D366]/30 cursor-pointer">
          Shop Now
        </div>
      </div>
    </div>
    <div className="absolute top-1/4 -left-12 lg:-left-20 bg-card border border-border p-4 rounded-2xl shadow-xl flex items-center gap-4 animate-[bounce_4s_infinite]">
      ...
      <div className="flex flex-col pr-4">
        <span className="text-sm font-bold text-foreground">Open Rate</span>
        <span className="text-xs text-muted-foreground">95% Average</span>
      </div>
    </div>
    <div className="absolute bottom-1/4 -right-8 lg:-right-12 bg-[#25D366] text-white p-4 rounded-2xl shadow-xl flex flex-col gap-1 animate-[bounce_5s_infinite_reverse]">
      <span className="text-sm font-bold opacity-90">ROAS</span>
      <span className="text-2xl font-black">10x</span>
    </div>
  </div>
);
...
const ReturnsVisual = () => (
  <div className="relative w-full max-w-[320px] bg-card border border-border rounded-[2.5rem] shadow-2xl overflow-hidden aspect-[9/19] flex flex-col ring-8 ring-background">
    ...
    <div className="flex-1 p-5 flex flex-col gap-4 bg-background">
      ...
      <div className="mt-auto w-full py-3 bg-primary text-primary-foreground rounded-xl font-bold text-sm text-center">
        Confirm Exchange
      </div>
    </div>
    <div className="absolute top-1/4 -left-12 lg:-left-20 bg-card border border-border p-4 rounded-2xl shadow-xl flex items-center gap-4 animate-[bounce_4s_infinite]">
      ...
      <div className="flex flex-col pr-4">
        ...
        <span className="text-xs text-muted-foreground">Via Exchanges</span>
      </div>
    </div>
  </div>
);
  ...
  <div className="relative w-full max-w-[320px] bg-card border border-border rounded-[2.5rem] shadow-2xl overflow-hidden aspect-[9/19] flex flex-col ring-8 ring-background">
    ...
    <div className="flex-1 p-5 flex flex-col bg-background">
      ...
      <div className="grid grid-cols-4 gap-2 mb-6">
        <div className="py-2 border border-border rounded-lg text-center text-sm">
          S
        </div>
        <div className="py-2 border-2 border-primary bg-primary/5 rounded-lg text-center font-bold text-sm text-primary">
          M
        </div>
        <div className="py-2 border border-border rounded-lg text-center text-sm">
          L
      ...
      <div className="mt-auto w-full py-4 bg-foreground text-background rounded-xl font-bold text-sm text-center">
        Add to Cart
      </div>
    </div>
    <div className="absolute top-1/4 -right-12 lg:-right-20 bg-card border border-border p-4 rounded-2xl shadow-xl flex items-center gap-4 animate-[bounce_4s_infinite]">
      ...
      <div className="flex flex-col pr-4">
        <span className="text-sm font-bold text-foreground">AOV Increase</span>
        <span className="text-xs text-muted-foreground">+15% Average</span>
      </div>
    </div>
  </div>
);
...
const ShieldVisual = () => (
  <div className="relative w-full max-w-[320px] bg-card border border-border rounded-[2.5rem] shadow-2xl overflow-hidden aspect-[9/19] flex flex-col ring-8 ring-background">
    <div className="flex-1 bg-black flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <h3 className="text-white font-bold text-xl mb-2 z-10">
        High Risk Detected
      </h3>
      <p className="text-white/60 text-center text-sm mb-8 z-10">
        This user has a 95% RTO history. Order blocked automatically.
      </p>
      ...
      <div className="w-full bg-white/10 rounded-xl p-4 backdrop-blur-md border border-white/10 z-10">
        ...
        <div className="flex justify-between items-center mb-3">
          ...
          <span className="text-red-400 font-bold text-sm bg-red-400/10 px-2 py-0.5 rounded">
            COD
          </span>
        </div>
    ...
    <div className="absolute top-1/4 -left-12 lg:-left-20 bg-card border border-border p-4 rounded-2xl shadow-xl flex items-center gap-4 animate-[bounce_4s_infinite]">
      ...
      <div className="flex flex-col pr-4">
        <span className="text-sm font-bold text-foreground">RTO Reduced</span>
  ...
  <div className="relative w-full max-w-[320px] bg-card border border-border rounded-[2.5rem] shadow-2xl overflow-hidden aspect-[9/19] flex flex-col ring-8 ring-background">
    <div className="h-14 border-b border-border flex items-center px-6 bg-muted/30 pt-4">
      <div className="text-sm font-bold text-foreground flex items-center gap-2">
        <ShoppingCart size={14} /> Cart Recovery
      </div>
    </div>
    <div className="flex-1 p-5 flex flex-col gap-4 bg-background relative">
      ...
      <div className="relative z-10 flex gap-4 mt-2">
        <div className="w-8 h-8 rounded-full bg-red-500/20 text-red-500 flex items-center justify-center shrink-0 border-2 border-background">
      ...
      <div className="relative z-10 flex gap-4 mt-4">
        <div className="w-8 h-8 rounded-full bg-[#25D366]/20 text-[#25D366] flex items-center justify-center shrink-0 border-2 border-background">
          <MessageSquare size={14} />
        </div>
        <div className="bg-card border border-border p-3 rounded-xl flex-1 shadow-sm">
          ...
          <div className="bg-muted p-2 rounded text-[10px] italic">
            &quot;Hey! You left something behind. Take 10% off to complete it
            now.&quot;
          </div>
        </div>
      </div>
      ...
      <div className="relative z-10 flex gap-4 mt-4">
        <div className="w-8 h-8 rounded-full bg-primary flex items-center justify-center text-primary-foreground shrink-0 border-2 border-background shadow-lg shadow-primary/20">
          <BadgeCheck size={14} />
        </div>
    ...
    <div className="absolute bottom-1/4 -right-8 lg:-right-12 bg-card border border-border p-4 rounded-2xl shadow-xl flex items-center gap-4 animate-[bounce_5s_infinite_reverse]">
      ...
      <div className="flex flex-col pr-4">
        <span className="text-sm font-bold text-foreground">Revenue Saved</span>
        <span className="text-xs text-muted-foreground">22% Recovery Rate</span>
      </div>
    </div>
  </div>
);
...
const productsData = {
  care: {
    ...
    description:
      "Transform your customer experience with intelligent, always-on voice and chat automation designed specifically for D2C brands.",
    icon: Headset,
    visual: <CareVisual />,
    features: [
      {
        title: "AI 24/7 Customer Care Calls",
        desc: "Handle thousands of customer queries simultaneously with human-like voice AI.",
      },
      {
        title: "AI 24/7 Chat Support",
        desc: "Instant resolution across WhatsApp, Instagram, and web chat.",
      },
    ],
  },
  engage: {
    ...
    description:
      "Drive repeat purchases and turn anonymous visitors into loyal customers through hyper-personalized messaging.",
    icon: MessageSquare,
    visual: <EngageVisual />,
    features: [
      {
        title: "WhatsApp Marketing",
        desc: "Send targeted broadcast campaigns with high read and conversion rates.",
      },
      {
        title: "Utility Messages",
        desc: "Automated order updates, shipping alerts, and payment links.",
      },
      {
        title: "Visitor Connect",
        desc: "Identify website visitors and automatically send relevant WhatsApp marketing messages to convert them.",
      },
    ],
  },
  returns: {
    ...
    description:
      "Turn a logistical nightmare into a seamless customer experience while retaining revenue through exchanges.",
    icon: RotateCcw,
    visual: <ReturnsVisual />,
    features: [
      {
        title: "Returns Management",
        desc: "Automated return approvals, reverse pickup scheduling, and instant refunds.",
      },
      {
        title: "Exchange Management",
        desc: "Encourage size/color exchanges over refunds with a frictionless 1-click exchange portal.",
      },
    ],
  },
  convert: {
    ...
    description:
      "Maximize every visitor's value with AI-powered conversion tools that reduce friction and increase AOV.",
    icon: ShoppingCart,
    visual: <ConvertVisual />,
    features: [
      {
        title: "AI Size Recommendation",
        desc: "Eliminate fit-related returns with precision AI sizing.",
      },
      {
        title: "Virtual Try-On",
        desc: "Boost buyer confidence with interactive AR try-ons.",
      },
      {
        title: "Estimated Delivery Date by Pincode",
        desc: "Increase conversion by showing accurate delivery timelines upfront.",
      },
      {
        title: "AI Shopping Assistant",
        desc: "A pre-purchase chatbot that helps users find the right products instantly.",
      },
      {
        title: "Smart Upsell",
        desc: "Post-purchase upsells with one-click order add-ons.",
      },
    ],
  },
  shield: {
    ...
    description:
      "Protect your margins. Prevent fake orders and reduce RTO before the package even leaves your warehouse.",
    icon: ShieldCheck,
    visual: <ShieldVisual />,
    features: [
      {
        title: "COD Confirmation Calls",
        desc: "Automated AI voice calls to confirm intent on all Cash on Delivery orders.",
      },
      {
        title: "COD WhatsApp Verification",
        desc: "Frictionless WhatsApp-based OTP verification for high-risk orders.",
      },
      {
        title: "AI RTO Risk Detection",
        desc: "Predictive scoring to flag and block serial returners automatically.",
      },
    ],
  },
  recover: {
    ...
    description:
      "Reclaim lost revenue and improve cash flow with intelligent automated follow-ups.",
    icon: RefreshCw,
    visual: <RecoverVisual />,
    features: [
      {
        title: "AI Cart Recovery",
        desc: "Multi-channel automated sequences to bring abandoned carts back to checkout.",
      },
      {
        title: "COD to Prepaid Conversions",
        desc: "Incentivize customers to switch from COD to Prepaid via automated WhatsApp offers.",
      },
    ],
  },
};
              ...
              <div className="flex flex-col items-start text-left max-w-2xl z-10">
                ...
                <div className="flex flex-wrap items-center gap-4 mb-8">
                  ...
                  <div className="flex items-center gap-1.5 text-xs font-bold text-muted-foreground uppercase tracking-widest bg-card border border-border px-4 py-2 rounded-full">
                    <span className="text-orange-400 text-sm tracking-tighter">
                      ★★★★★
                    </span>{" "}
                    on Shopify
                  </div>
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
                  <Link
                    href="/login"
                    className="w-full sm:w-auto px-8 py-4 rounded-full bg-primary text-primary-foreground font-bold hover:bg-primary/90 transition-all shadow-lg shadow-primary/20 text-sm tracking-widest uppercase text-center flex items-center justify-center"
                  >
                    Sign Up Now
                  </Link>
                  <button
            ...
            <div className="border-t border-border pt-20">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {product.features.map((feature, idx) => (
                  <div
                    key={idx}
                    className="p-8 rounded-xl border border-border bg-card shadow-sm flex flex-col hover:border-primary/50 transition-colors"
                  >

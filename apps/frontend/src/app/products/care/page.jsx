...
export default function CareProductPage() {
  ...
  const transcripts = {
    Hindi:
      "Namaste! Aapka order #ORD-992 aaj shaam 5 baje se pehle delivery ke liye scheduled hai.",
    Tamil:
      "Vanakkam! Ungaludaiya order #ORD-992 indru kaalai paththu manikku delivery seiyya scheduled seiyya pattulladhu.",
    Telugu:
      "Namaskaram! Mee order #ORD-992 eeroju saayantram 5 gantalalopu delivery ki schedule cheyabadindhi.",
    English:
      "Hello! Your shipment #ORD-992 is scheduled for courier delivery today before 5 PM.",
  };
  ...
  const handlePlayPause = () => {
    if (!audioRef.current) {
      ...
      !audioRef.current.src.endsWith(audioFiles[selectedLang])
    ) {
                ...
                <div className="lg:col-span-6 flex flex-col items-start text-left z-10">
                  ...
                  <FadeInUp delay={0.3}>
                    <p className="text-base sm:text-lg md:text-xl text-muted-foreground leading-relaxed mb-10 max-w-xl">
                      Resolve customer service inquiries instantly with
                      human-quality AI voice calls and intelligent WhatsApp
                      chatbots. Cut support costs by <b>60%</b> while boosting
                      CSAT.
                    </p>
                  </FadeInUp>
                  <FadeInUp
                          ...
                          <div className="p-4 sm:p-6 rounded-2xl bg-gradient-to-br from-slate-900 to-brand-navy text-white border border-white/10 shadow-lg space-y-5">
                            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                              ...
                              <div className="flex flex-wrap gap-1">
                                {["Hindi", "Tamil", "Telugu", "English"].map(
                                  (l) => (
                                    <button
                                      key={l}
                            ...
                            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 p-4 rounded-xl bg-white/5 border border-white/10">
                              ...
                              <div className="flex-1">
                                <p className="text-xs font-extrabold text-white">
                                  Autoshipp AI Voice ({selectedLang})
                                </p>
                                <p className="text-[11px] text-emerald-300 font-mono">
                                  &quot;{transcripts[selectedLang]}&quot;
                                </p>
                              </div>
                            </div>
                            ...
                            <div className="flex items-end justify-center gap-1 sm:gap-1.5 h-12 px-2 sm:px-4 py-2 bg-black/40 rounded-xl border border-white/5 overflow-hidden">
                              {[
                                40, 70, 30, 90, 60, 100, 50, 80, 45, 85, 35, 95,
                                60, 40,
                              ].map((h, i) => (
                                <motion.div
                                  key={i}
                          ...
                          <div className="p-4 sm:p-5 rounded-2xl bg-muted/60 border border-border space-y-3 font-sans">
                            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between border-b border-border pb-2.5 gap-2">
                              <span className="text-xs font-bold text-foreground">
                                Verified WhatsApp Official Account
                              </span>
                              <span className="text-[10px] font-mono bg-success/15 text-success px-2 py-0.5 rounded-full font-bold">
                                ● Instant AI Reply
                              </span>
                            </div>
                            ...
                            <div className="space-y-2 text-xs">
                              <div className="bg-background p-3 rounded-2xl rounded-tl-xs border border-border max-w-[85%]">
                                <p className="text-muted-foreground text-[10px] font-bold mb-0.5">
                                  Shopper (10:14 AM)
                                </p>
                                <p className="text-foreground font-medium">
                                  Can I change my delivery address to
                                  Koramangala 4th Block?
                                </p>
                              </div>

                              <div className="bg-success/15 p-3 rounded-2xl rounded-tr-xs border border-success/30 ml-auto max-w-[85%] text-foreground">
                                <p className="text-success text-[10px] font-extrabold mb-0.5">
                                  Autoshipp Bot (10:14 AM)
                                </p>
                                <p className="font-semibold">
                                  Address updated successfully! I’ve alerted
                                  Delhivery courier partner. Your new tracking
                                  link is ready.
                                </p>
                              </div>
                            </div>
              ...
              <div className="grid lg:grid-cols-12 gap-16 items-center">
                  ...
                  <div className="bg-gradient-to-tr from-brand-orange/10 via-card to-brand-blue/10 border border-border rounded-3xl sm:rounded-[3rem] p-4 sm:p-8 shadow-xl">
                    <div className="bg-background border border-border rounded-3xl p-4 sm:p-6 shadow-md space-y-6">
                      ...
                      <p className="text-sm text-muted-foreground leading-relaxed">
                        Unlike robotic IVR menus (*&quot;Press 1 for
                        English&quot;*), Autoshipp Care utilizes generative
                        speech neural models. Shoppers speak naturally, and our
                        AI understands regional dialects, background noise, and
                        intent instantly.
                      </p>
                ...
                <div className="lg:col-span-6 order-1 lg:order-2 space-y-6">
                  ...
                  <h2 className="text-4xl md:text-5xl font-black text-foreground tracking-tight leading-[1.1]">
                    ...
                    <span className="text-brand-orange">Zero Hold Times.</span>
                  </h2>
                  <p className="text-lg text-muted-foreground leading-relaxed">
                    Delight your customers with empathetic, natural inbound
                    voice support. From answering shipment inquiries to
                    processing cancellations, our voice agent resolves customer
                    queries instantly with human-like understanding.
                  </p>
                  <ul className="space-y-3 pt-2 text-foreground font-medium text-base">
                    <li className="flex items-center gap-3">
                      <CheckCircle2 className="w-5 h-5 text-brand-orange shrink-0" />
                      <span>
                        <strong>Dialect &amp; Emotion AI:</strong> Detects
                        customer frustration and adapts tone appropriately.
                      </span>
                    </li>
                    <li className="flex items-center gap-3">
                      <CheckCircle2 className="w-5 h-5 text-brand-orange shrink-0" />
                      <span>
                        <strong>Instant CRM &amp; OMS Lookup:</strong> Fetches
                        Shopify cart items and courier tracking live during
                        calls.
                      </span>
                    </li>
                  </ul>
            ...
            <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-11">
              <FadeInUp className="text-center max-w-3xl mx-auto mb-20">
                <h2 className="text-4xl md:text-5xl font-black tracking-tight text-foreground mb-6">
                  Support Built for Indian Commerce
                </h2>
                <p className="text-lg text-muted-foreground">
                  Scale your customer satisfaction ratings without linearly
                  increasing your support headcount.
                </p>
              </FadeInUp>
            ...
            <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-12">
              <div className="max-w-2xl">
                <h2 className="text-4xl lg:text-5xl font-black mb-6">
                  Ready to Cut Support Costs by 60%?
                </h2>
                <p className="text-lg text-slate-300 mb-8 leading-relaxed">
                  Deploy Autoshipp Care across your telephone numbers and
                  WhatsApp channels today. Provide 24/7 autonomous resolution
                  with human empathy.
                </p>
                <button
                  onClick={() => setBookDemoOpen(true)}

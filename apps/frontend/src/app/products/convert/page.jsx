...
export default function ConvertProductPage() {
  ...
  const [etaResult, setEtaResult] = useState(
    "Estimated Delivery: 2 to 3 Days (Metro Air)",
  );
            ...
            <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-11">
              <div className="grid lg:grid-cols-12 gap-12 items-center">
                ...
                <div className="lg:col-span-6 flex flex-col items-start text-left z-10">
                  <FadeInUp delay={0.1}>
                    <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-brand-orange/10 text-brand-orange text-xs tracking-widest font-extrabold mb-8 uppercase border border-brand-orange/20 shadow-2xs">
                      <Sparkles className="w-3.5 h-3.5" /> Virtual Trial Room
                      &bull; Pincode AI
                    </div>
                  </FadeInUp>
                  <FadeInUp delay={0.2}>
                  ...
                  <FadeInUp delay={0.3}>
                    <p className="text-base sm:text-lg md:text-xl text-muted-foreground leading-relaxed mb-10 max-w-xl">
                      Transform hesitant window shoppers into high-confidence
                      buyers with our AR Virtual Trial Room, predictive Pincode
                      ETA calculator, and AI size intelligence suite.
                    </p>
                  </FadeInUp>
                  <FadeInUp
                    delay={0.4}
                ...
                <div className="lg:col-span-6 relative z-10 w-full overflow-hidden">
                  <ScaleIn
                    delay={0.4}
                    className="w-full bg-card border border-border rounded-3xl sm:rounded-[3rem] shadow-2xl p-4 sm:p-8 relative overflow-hidden"
                  >
                            ...
                            <div className="flex flex-col items-stretch gap-3">
                              ...
                              <div className="flex items-center gap-4 p-3 bg-white/5 border border-white/10 rounded-xl">
                                ...
                                <div className="text-left">
                                  <span className="text-[9px] font-bold text-cyan-300 uppercase block">
                                    Step 1: Customer Image
                                  </span>
                                  <h4 className="text-xs font-extrabold text-white">
                                    Upload your selfie
                                  </h4>
                                  <p className="text-[10px] text-slate-400">
                                    Provide a front-facing full-body or
                                    half-body photo.
                                  </p>
                                </div>
                              </div>

                              <div className="text-brand-orange text-center text-xs font-black">
                                ↓
                              </div>
                              ...
                              <div className="flex items-center gap-4 p-3 bg-white/5 border border-white/10 rounded-xl">
                                ...
                                <div className="text-left">
                                  ...
                                  <p className="text-[10px] text-slate-400">
                                    Select any apparel from the merchant
                                    catalog.
                                  </p>
                                </div>
                              </div>
                              ...
                              <div className="flex items-center gap-4 p-3 bg-gradient-to-r from-cyan-500/15 via-brand-blue/25 to-brand-orange/15 border border-cyan-500/30 rounded-xl">
                                <div className="w-12 h-16 rounded-lg overflow-hidden shrink-0 bg-slate-800 border border-cyan-500/30 relative">
                                  <Image
                                    ...
                                    height={64}
                                    className="w-full h-full object-cover"
                                    alt="AI Try-On Synthesis"
                                  />
                                </div>
                                <div className="text-left">
                                  <span className="text-[9px] font-bold text-cyan-300 uppercase block">
                                    Step 3: Generated AI Try-On
                                  </span>
                                  <h4 className="text-xs font-extrabold text-white">
                                    Receive try-on in seconds
                                  </h4>
                                  <p className="text-[10px] text-slate-300 leading-normal">
                                    Diffusion models map the garment to your
                          ...
                          <div className="p-4 sm:p-6 rounded-2xl bg-muted/60 border border-border space-y-4 text-left">
                            <div className="flex items-center justify-between border-b border-border pb-3 mb-2">
                              <span className="text-xs font-bold text-muted-foreground uppercase tracking-widest">
                                Live Delivery Estimate Widget
                              </span>
                              <span className="text-[10px] font-bold bg-brand-orange/15 text-brand-orange px-2 py-0.5 rounded-full uppercase text-center">
                                Pincode Script Active
                              </span>
                            </div>
              ...
              <div className="grid lg:grid-cols-12 gap-16 items-center">
                        ...
                        <div className="aspect-3/4 rounded-2xl bg-slate-900 border border-border relative flex flex-col justify-between p-4 overflow-hidden group">
                          ...
                          <div className="relative z-10">
                            <p className="text-white text-xs font-bold">
                              User Full-Body Image
                            </p>
                            <p className="text-[10px] text-slate-300">
                              Preserves facial features &amp; pose
                            </p>
                          </div>
                        </div>
                        <div className="aspect-3/4 rounded-2xl bg-gradient-to-br from-brand-blue/20 to-brand-orange/10 border border-brand-blue/30 p-4 flex flex-col justify-between relative overflow-hidden">
                          ...
                          <div className="space-y-1">
                            <span className="text-xs font-extrabold text-foreground block">
                              Exact Garment Placed
                            </span>
                            <p className="text-[11px] text-muted-foreground leading-relaxed">
                              Generated image wrapping dress onto body
                              flawlessly.
                            </p>
                          </div>
                ...
                <div className="lg:col-span-6 order-1 lg:order-2 space-y-6">
                  <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-brand-blue/10 text-brand-blue text-xs font-extrabold tracking-wider uppercase">
                    <Sparkles className="w-3.5 h-3.5" /> AI Working Model &bull;
                    Generative Try-On
                  </div>
                  <h2 className="text-4xl md:text-5xl font-black text-foreground tracking-tight leading-[1.1]">
                    Upload a Photo. See the Dress on Your Body{" "}
                    <span className="text-brand-blue">Instantly.</span>
                  </h2>
                  <p className="text-lg text-muted-foreground leading-relaxed">
                    This is not a clunky 3D avatar or robotic AR overlay.
                    Autoshipp Convert’s Virtual Trial Room is a state-of-the-art
                    AI generative working model. When a user uploads their image
                    while viewing a product, our AI synthesizes a photorealistic
                    try-on image placing that exact dress onto their body
                    perfectly.
                  </p>
                  <ul className="space-y-3 pt-2 text-foreground font-medium text-base">
                    <li className="flex items-center gap-3">
                      ...
                      <span>
                        <strong>Accurate Fit &amp; Drape:</strong> Generates
                        realistic fabric tension, natural folds, and authentic
                        hem wrapping.
                      </span>
                    </li>
                    <li className="flex items-center gap-3">
                      <CheckCircle2 className="w-5 h-5 text-brand-blue shrink-0" />
                      <span>
                        <strong>Zero 3D Modeling Required:</strong> Works
                        directly from standard product catalog photos and user
                        uploads.
                      </span>
                    </li>
                    <li className="flex items-center gap-3">
                      <CheckCircle2 className="w-5 h-5 text-brand-blue shrink-0" />
                      <span>
                        <strong>1-Line Javascript SDK:</strong> Plugs seamlessly
                        into Shopify, WooCommerce, Next.js, and custom carts.
                      </span>
                    </li>
                  </ul>
                </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="grid lg:grid-cols-12 gap-16 items-center">
                ...
                <div className="lg:col-span-6 space-y-6">
                  ...
                  <h2 className="text-4xl md:text-5xl font-black text-foreground tracking-tight leading-[1.1]">
                    Eliminate Checkout Hesitation with{" "}
                    <span className="text-brand-orange">Reliable ETAs.</span>
                  </h2>
                  <p className="text-lg text-muted-foreground leading-relaxed">
                    &quot;When will my order arrive?&quot; is the #1 reason
                    carts get abandoned. Our pincode engine evaluates real-time
                    courier partner transit SLAs across 28,000+ Indian pincodes
                    and displays reliable delivery estimate windows (e.g. 3 to 5
                    days).
                  </p>
                  <ul className="space-y-3 pt-2 text-foreground font-medium text-base">
                    <li className="flex items-center gap-3">
                      ...
                      <span>
                        <strong>Live Courier Mapping:</strong> Evaluates
                        BlueDart, Delhivery, Express, and Xpressbees transit
                        times dynamically.
                      </span>
                    </li>
                    <li className="flex items-center gap-3">
                      <CheckCircle2 className="w-5 h-5 text-brand-orange shrink-0" />
                      <span>
                        <strong>Cart Abandonment Shield:</strong> +23% increase
                        in checkout completion when transparent delivery day
                        estimates are shown.
                      </span>
                    </li>
                    <li className="flex items-center gap-3">
                      <CheckCircle2 className="w-5 h-5 text-brand-orange shrink-0" />
                      <span>
                        <strong>Smart Holiday Buffers:</strong> Automatically
                        accounts for Indian regional festivals and Sunday
                        cutoffs.
                      </span>
                    </li>
                  </ul>
                  ...
                  <div className="bg-card border border-border rounded-[3rem] p-8 sm:p-12 shadow-xl space-y-6">
                    ...
                    <div className="p-6 rounded-2xl bg-muted/60 border border-border space-y-4">
                      <div className="flex justify-between items-center text-sm">
                        ...
                        <span className="font-mono font-extrabold text-foreground bg-background px-3 py-1 rounded-lg border border-border">
                          600001 (Chennai)
                        </span>
                      </div>
              ...
              <div className="grid lg:grid-cols-12 gap-16 items-center">
                  ...
                  <div className="bg-gradient-to-tr from-success/10 via-card to-brand-blue/10 border border-border rounded-3xl sm:rounded-[3rem] p-6 sm:p-10 shadow-xl space-y-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="p-4 bg-muted/50 border border-border rounded-2xl flex items-center gap-4">
                        ...
                        <div>
                          <h4 className="text-xs font-black text-foreground uppercase">
                            1. Merchant Database Fetch
                          </h4>
                          <p className="text-xs text-muted-foreground mt-0.5">
                            Fetches specific sizing charts (chest, waist,
                            inseam) directly from your OMS.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="p-4 bg-muted/50 border border-border rounded-2xl flex items-center gap-4">
                        ...
                        <div>
                          <h4 className="text-xs font-black text-foreground uppercase">
                            2. Customer Body Input
                          </h4>
                          <p className="text-xs text-muted-foreground mt-0.5">
                            Shopper enters height, weight, and preferred wear
                            profile (Slim, Oversized, etc.).
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="p-4 bg-success/10 border border-success/30 rounded-2xl flex items-center gap-4">
                        ...
                        <div>
                          <h4 className="text-xs font-black text-success uppercase">
                            3. Matched AI Output
                          </h4>
                          <p className="text-xs text-success font-medium mt-0.5">
                            Delivers a personalized recommendation (98.4%
                            accuracy) instead of generic size tables.
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                <div className="lg:col-span-6 order-1 lg:order-2 space-y-6">
                  ...
                  <h2 className="text-4xl md:text-5xl font-black text-foreground tracking-tight leading-[1.1]">
                    ...
                    <span className="text-success">Goodbye Returns.</span>
                  </h2>
                  <p className="text-lg text-muted-foreground leading-relaxed">
                    Sizing discrepancies account for over 50% of apparel
                    exchanges. Autoshipp Convert&apos;s Size AI bypasses generic
                    size charts by dynamically reading the merchant&apos;s
                    database parameters and comparing them with shopper height,
                    weight, and fit style goals.
                  </p>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
                    <div className="p-4 rounded-xl border border-border bg-card">
                      ...
                      <p className="text-xs text-muted-foreground leading-relaxed font-medium">
                        Reads unique product measurements directly from the
                        brand&apos;s database.
                      </p>
                    </div>
                    <div className="p-4 rounded-xl border border-border bg-card">
                      ...
                      <p className="text-xs text-muted-foreground leading-relaxed">
                        Calculates body mass index and proportions from basic
                        height/weight inputs.
                      </p>
                    </div>
                    <div className="p-4 rounded-xl border border-border bg-card">
                      <h4 className="text-sm font-bold text-foreground mb-1">
                        Product Size Chart Matching
                      </h4>
                      <p className="text-xs text-muted-foreground leading-relaxed">
                        Matches data segments instantly with item dimensions.
                      </p>
                    </div>
                    <div className="p-4 rounded-xl border border-border bg-card">
                      <h4 className="text-sm font-bold text-foreground mb-1">
                      ...
                      <p className="text-xs text-muted-foreground leading-relaxed font-medium">
                        Replaces static size charts with customized shopper fit
                        predictions.
                      </p>
                    </div>
                    <div className="p-4 rounded-xl border border-border bg-card">
                      ...
                      <p className="text-xs text-muted-foreground leading-relaxed">
                        Minimizes size-related reverse logistics calls and costs
                        by up to 45%.
                      </p>
                    </div>
                    <div className="p-4 rounded-xl border border-border bg-card">
                      ...
                      <p className="text-xs text-muted-foreground leading-relaxed">
                        Boosts shopping cart progression by removing size
            ...
            <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-11">
              <FadeInUp className="text-center max-w-3xl mx-auto mb-20">
                <h2 className="text-4xl md:text-5xl font-black tracking-tight text-foreground mb-6">
                  Every Tool to Maximise Conversions
                </h2>
                <p className="text-lg text-muted-foreground">
                  Reduce friction, increase shopper confidence, and grow Average
                  Order Value on every visitor.
                </p>
              </FadeInUp>
            ...
            <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-12">
              <div className="max-w-2xl">
                <h2 className="text-4xl lg:text-5xl font-black mb-6 tracking-tight">
                  Boost AOV by 35% on every order
                </h2>
                <p className="text-lg text-slate-300 mb-8 leading-relaxed">
                  Autoshipp Convert&apos;s Virtual Trial Room and personalised
                  upsell engine surface the right sizing and products at the
                  right moment, dramatically increasing basket sizes.
                </p>
                <button
                  onClick={() => setBookDemoOpen(true)}
                  className="flex items-center gap-2 text-brand-orange font-extrabold hover:text-white transition-colors cursor-pointer text-base"
                >
              ...
              <div className="grid grid-cols-2 gap-6 w-full lg:w-auto shrink-0">
                <div className="bg-white/10 p-8 rounded-3xl border border-white/10 backdrop-blur-md text-center">
                  <p className="text-4xl lg:text-5xl font-black text-brand-orange mb-2">
                    35%
                  </p>

...
export default function RecoverProductPage() {
  ...
  const features = [
    ...
    },
    {
      ...
      icon: (
        <MessageSquare className="w-6 h-6 text-brand-navy dark:text-amber-400" />
      ),
    },
  ];
                ...
                <div className="lg:col-span-6 flex flex-col items-start text-left z-10">
                  <FadeInUp delay={0.1}>
                    <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-brand-orange/10 text-brand-orange text-xs tracking-widest font-extrabold mb-8 uppercase border border-brand-orange/20 shadow-2xs">
                      <Sparkles className="w-3.5 h-3.5" /> Revenue Recovery
                      Engine
                    </div>
                  </FadeInUp>
                  <FadeInUp delay={0.2}>
                  ...
                  <FadeInUp delay={0.3}>
                    <p className="text-lg md:text-xl text-muted-foreground leading-relaxed mb-10 max-w-xl">
                      Convert 3x more abandoned checkouts than email with
                      intelligent WhatsApp sequences and instantly flip
                      high-risk COD orders into secure UPI prepaid revenue.
                    </p>
                  </FadeInUp>
                          ...
                          <div className="p-5 rounded-2xl bg-slate-950 text-white border border-white/10 shadow-xl space-y-4">
                            <div className="flex items-center justify-between border-b border-white/10 pb-3">
                              <span className="text-xs font-bold text-slate-300 uppercase">
                                Automated WhatsApp Drip
                              </span>
                              <div className="flex gap-1">
                                {[1, 2, 3].map((s) => (
                                  <button
                                    key={s}
                                    onClick={() => setSequenceStep(s)}
                                    className={`px-2 py-0.5 rounded text-[10px] font-mono font-bold cursor-pointer transition-all ${sequenceStep === s ? "bg-brand-orange text-white" : "bg-white/10 text-slate-400"}`}
                                  >
                                    Stage {s}
                                  </button>
                                ))}
                            ...
                            <div className="p-3.5 rounded-xl bg-white/5 border border-white/10 space-y-2">
                              <div className="flex items-center justify-between text-[11px] font-mono text-amber-400">
                                <span>
                                  {sequenceStep === 1
                                    ? "⏱️ Triggered +60 Mins Post-Abandon"
                                    : sequenceStep === 2
                                      ? "🌟 Triggered +6 Hours (Social Proof)"
                                      : "⚡ Triggered +24 Hours (Urgency Coupon)"}
                                </span>
                                <span>● Live API</span>
                              </div>
                              <p className="text-xs text-slate-200 leading-relaxed">
                                {sequenceStep === 1 &&
                                  "Hi Sneha! Did you leave something behind? Your Wireless Noise-Cancelling Headphones (₹4,999) are safely saved in your bag. Tap to complete checkout before items sell out!"}
                                {sequenceStep === 2 &&
                                  "Hey Sneha! 🎧 Over 450 shoppers bought these headphones this week. Here’s what Amit says: 'Best audio bass under 5k!' Grab yours with Free Next-Day BlueDart Shipping."}
                                {sequenceStep === 3 &&
                                  "⚠️ Final Notice Sneha! We’ve unlocked an exclusive 15% OFF coupon (Code: COMEBACK15). This expires in exactly 2 hours. Tap below to buy now for ₹4,249!"}
                              </p>
                              <div className="pt-1">
                          ...
                          <div className="p-5 rounded-2xl bg-muted/50 border border-border space-y-4 font-sans">
                            ...
                            <div className="p-4 rounded-xl bg-background border border-border shadow-md space-y-3">
                              <p className="text-xs font-bold text-foreground">
                                Order #ORD-4491 &bull; ₹2,499 (Placed as COD)
                              </p>
                              <p className="text-[11px] text-muted-foreground leading-relaxed">
                                &quot;Hi Karthik! Convert your ₹2,499 COD order
                                to UPI Prepaid right now and get an instant ₹250
                                flat discount (+ Priority Same-Day
                                Dispatch).&quot;
                              </p>
              ...
              <div className="grid lg:grid-cols-12 gap-16 items-center">
                  ...
                  <div className="bg-gradient-to-tr from-brand-orange/10 via-card to-brand-blue/10 border border-border rounded-[3rem] p-8 shadow-xl">
                    <div className="bg-background border border-border rounded-3xl p-6 shadow-md space-y-6">
                      ...
                      <p className="text-sm text-muted-foreground leading-relaxed">
                        When a shopper drops off at your Shopify payment
                        gateway, Autoshipp Recover captures the exact cart
                        items, variant selections, and checkout URL. Within 60
                        minutes, our AI initiates an empathetic conversational
                        reminder.
                      </p>
                ...
                <div className="lg:col-span-6 order-1 lg:order-2 space-y-6">
                  <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-brand-orange/10 text-brand-orange text-xs font-extrabold tracking-wider uppercase">
                    <ShoppingCart className="w-3.5 h-3.5" /> Cart Recovery
                    Engine
                  </div>
                  <h2 className="text-4xl md:text-5xl font-black text-foreground tracking-tight leading-[1.1]">
                    Stop Leaving Carts Behind.{" "}
                    <span className="text-brand-orange">
                      Re-engage Instantly.
                    </span>
                  </h2>
                  <p className="text-lg text-muted-foreground leading-relaxed">
                    Over 75% of e-commerce shopping carts are abandoned before
                    purchase. Win back high-intent shoppers using multi-stage
                    messaging triggers that combine helpful reminders, authentic
                    customer reviews, and timed coupon nudges.
                  </p>
                  <ul className="space-y-3 pt-2 text-foreground font-medium text-base">
                    <li className="flex items-center gap-3">
                      <CheckCircle2 className="w-5 h-5 text-brand-orange shrink-0" />
                      <span>
                        <strong>Direct Cart Restoration:</strong> Tapping the
                        WhatsApp CTA link restores Shopify bag contents
                        instantly.
                      </span>
                    </li>
                    <li className="flex items-center gap-3">
                      <CheckCircle2 className="w-5 h-5 text-brand-orange shrink-0" />
                      <span>
                        <strong>Smart Exit-Intent Detection:</strong> Identifies
                        tab switching events to fire priority discount
                        interventions.
                      </span>
                    </li>
                  </ul>
            ...
            <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-11">
              <FadeInUp className="text-center max-w-3xl mx-auto mb-20">
                <h2 className="text-4xl md:text-5xl font-black tracking-tight text-foreground mb-6">
                  Designed to Plug Revenue Leaks
                </h2>
                <p className="text-lg text-muted-foreground">
                  Automatically turn dropped checkout sessions into paid
                  customer orders.
                </p>
              </FadeInUp>
            ...
            <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-12">
              <div className="max-w-2xl">
                <h2 className="text-4xl lg:text-5xl font-black mb-6">
                  Ready to Recover 35% of Lost Checkouts?
                </h2>
                <p className="text-lg text-slate-300 mb-8 leading-relaxed">
                  Equip your webstore with Autoshipp Recover today. Launch
                  automated WhatsApp cart win-back drips and flip risky COD
                  orders into UPI prepaid cash.
                </p>
                <button
                  onClick={() => setBookDemoOpen(true)}

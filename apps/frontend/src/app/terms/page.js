        ...
        <main className="flex-1 pt-36 pb-24">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-card/70 backdrop-blur-2xl border border-border rounded-3xl sm:rounded-[3rem] p-6 sm:p-16 shadow-2xl relative">
              <h1 className="text-3xl sm:text-5xl md:text-6xl font-black tracking-tight text-foreground mb-4 pb-8 border-b border-border/80">Terms of Service</h1>
              ...
              <div className="space-y-10 pt-4 text-base md:text-lg leading-relaxed text-muted-foreground/90">
                ...
                <section className="space-y-4 pt-2">
                  <h2 className="text-2xl sm:text-3xl font-black text-foreground mb-6">1. Description of Service</h2>
                  <p className="leading-relaxed">
                ...
                <section className="space-y-4 pt-4 border-t border-border/50">
                  <h2 className="text-2xl sm:text-3xl font-black text-foreground mb-6 pt-4">2. WhatsApp and Meta Integration</h2>
                  <p className="leading-relaxed">
                  ...
                  <h3 className="text-lg sm:text-xl font-bold text-foreground mb-3 mt-8 pt-2">2.1 Adherence to Third-Party Policies</h3>
                  <p className="leading-relaxed">
                  ...
                  <h3 className="text-lg sm:text-xl font-bold text-foreground mb-3 mt-8 pt-2">2.2 User Consent and Opt-In</h3>
                  <p className="leading-relaxed">
                ...
                <section className="space-y-4 pt-4 border-t border-border/50">
                  <h2 className="text-2xl sm:text-3xl font-black text-foreground mb-6 pt-4">3. Acceptable Use and Anti-Spam Policy</h2>
                  <p className="leading-relaxed">
                    You agree not to use the Services to:
                  </p>
                  <ul className="space-y-3 pl-6 list-disc marker:text-primary">
                    <li className="pl-2">Send spam, unsolicited promotional messages, or bulk messaging that violates Meta's policies.</li>
                    <li className="pl-2">Send content that is illegal, abusive, harassing, defamatory, fraudulent, or deceptive.</li>
                    <li className="pl-2">Transmit viruses, malware, or any other malicious code.</li>
                    <li className="pl-2">Interfere with or disrupt the integrity or performance of the Services or third-party data contained therein.</li>
                  </ul>
                ...
                <section className="space-y-4 pt-4 border-t border-border/50">
                  <h2 className="text-2xl sm:text-3xl font-black text-foreground mb-6 pt-4">4. Account Suspension and Termination</h2>
                  <p className="leading-relaxed">
                ...
                <section className="space-y-4 pt-4 border-t border-border/50">
                  <h2 className="text-2xl sm:text-3xl font-black text-foreground mb-6 pt-4">5. Limitation of Liability</h2>
                  <p className="leading-relaxed">
                ...
                <section className="space-y-4 pt-4 border-t border-border/50">
                  <h2 className="text-2xl sm:text-3xl font-black text-foreground mb-6 pt-4">6. Changes to Terms</h2>
                  <p className="leading-relaxed">
                ...
                <section className="mt-12 p-8 sm:p-10 rounded-[2rem] bg-muted/40 border border-border/80 shadow-xs">
                  <h2 className="text-2xl font-black text-foreground mb-4">7. Contact Us</h2>

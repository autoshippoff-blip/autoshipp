            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="space-y-8">
                ...
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight text-foreground leading-[1.1]">
                  Transforming COD Orders into{" "}
                  <span className="text-primary">Guaranteed Profit</span>
                </h1>
                <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">
                  D2C brands lose up to 30% of their revenue to RTOs (Return to
                  Origin). Autoshipp uses advanced AI Voice Automation and
                  WhatsApp confirmation to ensure high-intent deliveries and
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center max-w-3xl mx-auto mb-16">
                ...
                <p className="text-muted-foreground text-base sm:text-lg">
                  A comprehensive suite designed specifically for Indian D2C
                ...
                {[
                  {
                    ...
                    title: "Smart RTO Prevention",
                    desc: "Identify high-risk addresses and confirm intent before shipping.",
                  },
                  {
                    icon: <Zap className="w-8 h-8 text-warning" />,
                    title: "AI Voice & WhatsApp",
                    desc: "Automated 24/7 engagement that feels human and converts faster.",
                  },
                  {
                    icon: <TrendingUp className="w-8 h-8 text-success" />,
                    title: "Margin Recovery",
                    desc: "Turn abandoned carts and cancelled orders into fulfilled revenue.",
                  },
                ].map((benefit, i) => (
                  <div
                    key={i}
                    className="bg-card border border-border p-8 rounded-3xl hover:border-primary/50 transition-colors shadow-sm"
                  >
          ...
          <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold mb-4">
                Autoshipp vs. Traditional Methods
              </h2>
              <p className="text-muted-foreground text-lg">
                See exactly what you get and how much you save.
              </p>
            </div>
                  ...
                  {[
                    {
                      ...
                      text: "Manual calls by support agents taking 8-10 hours.",
                    },
                    {
                      title: "RTO Prevention",
                      text: "Basic pincode blocks missing real-time intent data.",
                    },
                    {
                      title: "Abandoned Cart",
                      text: "Generic email blasts with low open rates (10-15%).",
                    },
                    {
                      title: "Platform Tools",
                      text: "Multiple disjointed SaaS subscriptions.",
                    },
                    {
                      title: "Customer Support",
                      text: "Human Agents available only 8-10 Hours.",
                    },
                  ].map((item, i) => (
              ...
              <div className="bg-primary/5 border border-primary/20 rounded-3xl p-8 flex flex-col gap-6 shadow-xl hover:shadow-2xl transition-shadow relative overflow-hidden">
                ...
                <ul className="space-y-6">
                  {[
                    {
                      title: "Order Confirmation",
                      text: "Instant AI Voice & WhatsApp verification within seconds.",
                    },
                    {
                      title: "RTO Prevention",
                      text: "Advanced AI ML Models blocking high-risk orders instantly.",
                    },
                    {
                      title: "Abandoned Cart",
                      text: "Personalized WhatsApp engagement with 70%+ read rates.",
                    },
                    {
                      title: "Platform Tools",
                      text: "Unified dashboard managing everything from one place.",
                    },
                    {
                      title: "Customer Support",
                      text: "24/7 Multi-channel AI Agents supporting customers anytime.",
                    },
                  ].map((item, i) => (
                    <li key={i} className="flex items-start gap-4 group">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-muted-foreground mb-8 leading-relaxed">
                  Don&apos;t pay for multiple disjointed subscriptions.
                  Autoshipp combines marketing, returns management, risk
                  detection, and support automation into one predictable,
              ...
              <div className="bg-card border border-border rounded-3xl p-8 shadow-xl">
                <div className="mb-8">
                  ...
                  <div className="flex items-end gap-4">
                    <div className="flex flex-col items-center gap-2 flex-1">
                      <div
                        className="w-full bg-destructive/10 rounded-t-lg relative flex items-end justify-center"
                        style={{ height: "200px" }}
                      >
                        <div
                          className="w-full bg-destructive/30 rounded-t-lg"
                          style={{ height: "100%" }}
                        ></div>
                        <span className="absolute bottom-4 font-bold text-destructive-foreground">
                          ₹25,000+
                        </span>
                      </div>
                    ...
                    <div className="flex flex-col items-center gap-2 flex-1">
                      <div
                        className="w-full bg-primary/10 rounded-t-lg relative flex items-end justify-center"
                        style={{ height: "200px" }}
                      >
                        <div
                          ...
                          style={{ height: "40%" }}
                        ></div>
                        <span className="absolute bottom-4 font-bold text-primary-foreground">
                          from ₹1,999
                        </span>
                      </div>
                ...
                <p className="text-center text-sm text-muted-foreground">
                  Based on an average volume of 2000 orders/month.
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="bg-primary text-primary-foreground rounded-[2.5rem] p-12 text-center relative overflow-hidden">
              ...
              <div className="relative z-10">
                <h2 className="text-3xl md:text-5xl font-bold mb-6 tracking-tight">
                  Ready to transform your COD metrics?
                </h2>
                <p className="text-primary-foreground/80 text-lg mb-10 max-w-2xl mx-auto">
                  Join hundreds of top D2C brands taking control of their
                  fulfillment costs and delivering superior customer
                  experiences.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <button
                    onClick={() => setBookDemoOpen(true)}
                    className="px-8 py-4 rounded-xl bg-background text-foreground font-bold hover:bg-muted transition-colors shadow-xl"
                  >
                    Book a Live Demo
                  </button>
                  <Link
                    href="/login"
                    className="px-8 py-4 rounded-xl bg-primary-foreground/10 text-primary-foreground font-bold border border-primary-foreground/20 hover:bg-primary-foreground/20 transition-colors"
                  >
                    Start Free Trial
                  </Link>
                </div>

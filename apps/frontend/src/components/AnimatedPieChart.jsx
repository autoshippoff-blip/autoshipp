...
export default function AnimatedPieChart({ profit = 94, rto = 6 }) {
  ...
  if (!mounted) {
    return (
      <div className="w-full max-w-[400px] h-[440px] mx-auto bg-card/50 animate-pulse rounded-[2.5rem] border border-border" />
    );
  }
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center select-none pointer-events-none">
          ...
          >
            <div className="flex items-start">
              ...
              <span className="text-2xl font-extrabold text-emerald-500 mt-1 ml-0.5">
                %
              </span>
            </div>

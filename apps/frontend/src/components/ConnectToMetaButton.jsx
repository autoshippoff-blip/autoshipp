...
export default function ConnectToMetaButton({ className, onOpenBookDemo }) {
  ...
  const FACEBOOK_APP_ID =
    process.env.NEXT_PUBLIC_FACEBOOK_APP_ID || "1238432954736435";
  const META_CONFIG_ID =
    process.env.NEXT_PUBLIC_META_CONFIG_ID || "1729387431576184";
  ...
  const launchMetaEmbeddedSignup = async (tenantId) => {
    ...
    try {
      ...
      showToast(
        "error",
        "Meta SDK could not be loaded. Please disable ad-blocker.",
      );
      setStatus("idle");
    }
  };
            ...
            <div className="flex min-h-full items-center justify-center p-4">
              ...
              <div className="relative bg-card border border-border w-full max-w-md rounded-2xl shadow-2xl p-6 z-10 animate-in zoom-in-95 duration-200">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed mb-6">
                  Connect your WhatsApp Business account after creating your
                  Autoshipp workspace. Book a quick demo to get started.
                </p>
